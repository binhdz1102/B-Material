    ...
    Column(Modifier.height(300.dp)) {
        Row(
            ...
            Button(onClick = { scope.animateScrollToTag(bState, tag = "special") }) {
                Text("Scroll to #special", style = BTokens.typography.labelLarge)
            }
            Button(onClick = { scope.animateScrollToTag(bState, tag = "special2") }) {
                Text("Scroll to #special2", style = BTokens.typography.labelLarge)
            }
        }
        ...
        BLazyColumn(
            ...
            stickyHeader {
                Box(
                    ...
                    Text("Sticky header", style = BTokens.typography.titleSmall)
                }
            }
